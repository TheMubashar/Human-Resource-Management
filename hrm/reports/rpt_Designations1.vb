...
Public Class rpt_Designations
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "hrm.rpt_Designations.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Designations
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Designations = New rpt_Designations()
        rpt.Site = Me.Site
        Return rpt
    End Function
