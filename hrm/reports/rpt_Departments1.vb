...
Public Class rpt_Departments
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "hrm.rpt_Departments.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Departments
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Departments = New rpt_Departments()
        rpt.Site = Me.Site
        Return rpt
    End Function
