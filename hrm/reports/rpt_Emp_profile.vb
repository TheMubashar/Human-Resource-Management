...
Public Class rpt_Emp_profile
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "hrm.rpt_Emp_profile.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Emp_profile
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Emp_profile = New rpt_Emp_profile()
        rpt.Site = Me.Site
        Return rpt
    End Function
